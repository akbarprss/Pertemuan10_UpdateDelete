    ...
    public class DbContext : IDisposable
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"D:\MAIN STORAGE\Download\pert10\Pertemuan10\Operasi CRUD MVC Part #1\Operasi CRUD MVC Part #1\project\PerpustakaanAppMVC\Database\DbPerpustakaan.db";
